...
import { StyleSheet, AppRegistry, Alert, Platform, BackHandler, DeviceEventEmitter, AsyncStorage, Dimensions, TouchableOpacity, ActivityIndicator, View } from "react-native";
       ...
       headers: {
        ...
        .then((responseJson) => {
                 if(responseJson === 'Success') {
					  ...
					  Alert.alert("Sukses", "Anda berhasil Break In");
                        
                    }else{
                      
                      Alert.alert('Break In gagal','Silakan coba lagi!');
        ...
        body: JSON.stringify({
            ...
            .then((responseJson) => {
                 if(responseJson === 'Data Matched') {
                      console.log(responseJson);
					  Alert.alert("Maaf", "Anda sudah melakukan clocking break in hari ini");
					  this.props.navigation.navigate("Attendance")
