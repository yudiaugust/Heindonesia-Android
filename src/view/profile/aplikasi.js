...
export default class Aplikasi extends React.Component {
	constructor(props) {
 super(props);
   this.state = {
	   isLoading: true,
  ...
  render() {
    ...
    return (
      <Container>
          <WebView
			originWhitelist={['*']}
			source={{html: this.state.aplikasi}}
		  />
        <Footer>
...
Aplikasi.navigationOptions = ({ navigation }) => ({
  header: (
