...
export default class OvertimeIn extends React.Component {
	_isMounted = false;
	constructor(props) {
  super(props);
       ...
       headers: {
        ...
        .then((responseJson) => {
                 if(responseJson === 'Success') {
					  ...
					  Alert.alert("Sukses", "Anda berhasil Overtime In");
                        
                    }else{
                      
                      Alert.alert('Overtime In gagal','Silakan coba lagi!');
        ...
        body: JSON.stringify({
            ...
            .then((responseJson) => {
                 if(responseJson === 'Data Matched') {
                      console.log(responseJson);
					  Alert.alert("Maaf", "Anda sudah melakukan clocking Overtime In hari ini");
					  this.props.navigation.navigate("Attendance")
  ...
  render() {
    ...
    return (	
	  ...
	  <Content style={styles.contentAttendance}>
          <Form style={styles.formOvertimeIn}>
            <Item fixedLabel>
              <Label>
...
OvertimeIn.navigationOptions = ({ navigation }) => ({
  header: (
