...
export default class OvertimeOut extends React.Component {
	_isMounted = false;
	constructor(props) {
  super(props);
       ...
       headers: {
        ...
        .then((responseJson) => {
                 if(responseJson === 'Success') {
					  ...
					  Alert.alert("Sukses", "Anda berhasil Overtime Out");
                        
                    }else{
                      
                      Alert.alert('Overtime Out gagal','Silakan coba lagi!');
        ...
        body: JSON.stringify({
            ...
            .then((responseJson) => {
                 if(responseJson === 'Data Matched') {
                      console.log(responseJson);
					  Alert.alert("Maaf", "Anda sudah melakukan clocking Overtime Out hari ini");
					  this.props.navigation.navigate("Attendance")
  ...
  render() {
    ...
    return (	
	  ...
	  <Content style={styles.contentAttendance}>
          <Form style={styles.formOvertimeOut}>
            <Item fixedLabel>
              <Label>
...
OvertimeOut.navigationOptions = ({ navigation }) => ({
  header: (
