       ...
       headers: {
        ...
        .then((responseJson) => {
                 if(responseJson === 'Success') {
					  ...
					  Alert.alert("Sukses", "Anda berhasil Check Out");
                        
                    }else{
                      
                      Alert.alert('Check Out gagal','Silakan coba lagi!');
        ...
        body: JSON.stringify({
            ...
            .then((responseJson) => {
                 if(responseJson === 'Data Matched') {
                      console.log(responseJson);
					  Alert.alert("Maaf", "Anda sudah melakukan clocking Out hari ini");
					  this.props.navigation.navigate("Attendance")
  ...
  render() {
    ...
    return (	
	  ...
	  <Content style={styles.contentAttendance}>
          <Form style={styles.formCheckOut}>
            <Item fixedLabel>
              <Label>
