...
import { StyleSheet, AppRegistry, Alert, View, Platform, BackHandler, DeviceEventEmitter, AsyncStorage, Dimensions, TouchableOpacity, ActivityIndicator } from "react-native";
       ...
       headers: {
        ...
        .then((responseJson) => {
                 if(responseJson === 'Success') {
					  ...
					  Alert.alert("Sukses", "Anda berhasil Break Out");
                        
                    }else{
                      
                      Alert.alert('Break Out gagal','Silakan coba lagi!');
        ...
        body: JSON.stringify({
            ...
            .then((responseJson) => {
                 if(responseJson === 'Data Matched') {
                      console.log(responseJson);
					  Alert.alert("Maaf", "Anda sudah melakukan clocking break out hari ini");
					  this.props.navigation.navigate("Attendance")
...
BreakIn.navigationOptions = ({ navigation }) => ({
  header: (
